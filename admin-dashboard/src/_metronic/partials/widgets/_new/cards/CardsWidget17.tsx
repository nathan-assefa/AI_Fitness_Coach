...
const CardsWidget17: FC<Props> = ({
  ...
  const { revenueData, isLoading, error, unsubscribedUserList } =
    useFetchData();
      ...
      <div className="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
        ...
        <div className="d-flex flex-column content-justify-center flex-row-fluid">
          <div className="d-flex fw-semibold align-items-center">
            ...
            <div className="text-gray-500 flex-grow-1 me-4">Meal Plan</div>
            <div className="fw-bolder text-gray-700 text-xxl-end">
              ${revenueData?.meal_plan_revenue}
            </div>
          </div>
          <div className="d-flex fw-semibold align-items-center my-3">
            <div className="bullet w-8px h-3px rounded-2 bg-primary me-3"></div>
            <div className="text-gray-500 flex-grow-1 me-4">Workout Plan</div>
            <div className="fw-bolder text-gray-700 text-xxl-end">
              ${revenueData?.workout_plan_revenue}
            </div>
          </div>
          <div className="d-flex fw-semibold align-items-center">
            <div
            ...
            <div className=" fw-bolder text-gray-700 text-xxl-end">
              ${revenueData?.meal_workout_plan_revenue}
            </div>
          </div>
        </div>
      </div>
